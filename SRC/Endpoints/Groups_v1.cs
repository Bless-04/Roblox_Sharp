...
namespace Roblox_Sharp.Endpoints
{
    ...
    /// <b><see href="https://groups.roblox.com/docs//index.html">Groups Documentation v1</see></b>
    /// </summary>
    public static class Groups_v1
    {
        ...
        public static async Task<Group> Get_GroupAsync(ulong groupId)
        {
            ...
            return JsonSerializer.Deserialize<Group>(await Get_RequestAsync($"https://groups.roblox.com/v1/groups/{groupId}"))!;
        }
    }
}
